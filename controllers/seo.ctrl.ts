...
const SeoController = {
    ...
    updateSeoSettings: async (req: Request, res: Response) => {
        try {
            ...
            res.json({ success: true, message: 'SEO settings updated', data: settings });
        } catch (error) {
    ...
    resetSeoSettings: async (req: Request, res: Response) => {
        try {
            ...
            if (!existingSettings) {
                return res.status(404).json({ success: false, message: 'No settings to reset' });
            }
            ...
            res.json({ success: true, message: 'SEO settings reset to defaults', data: settings });
        } catch (error) {
